...
const LOGO_PRIMARY =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663430392752/ACudkEUZtZSJcQ9QHfKGZL/RF_primary_logo_transparent_195c0c4f.png";
...
const testimonials = [
  {
    ...
    quote:
      "I finally understood where my money was going. The cleanup matrix alone was worth it.",
    stars: 5,
  },
  {
    name: "Priya S.",
    ...
    quote:
      "The AI prompts saved me hours. I pasted them into ChatGPT and got a real action plan.",
    stars: 5,
  },
  {
    name: "Jordan K.",
    ...
    quote:
      "Clean, simple, and actually useful. I've tried three other planners — this one I actually filled out.",
    stars: 5,
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            <div className="max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
              ...
              >
                ...
                recommendations — so you can spend less time researching and
                more time doing.
              </motion.p>
              ...
              <motion.div
                ...
                animate="visible"
                custom={4}
                className="flex flex-col sm:flex-row sm:flex-wrap gap-3 justify-center lg:justify-start mb-6"
              >
                <Link href="/smart-money-os">
                  <Button
                    size="lg"
                    className="bg-slate-950 hover:bg-slate-800 text-white font-semibold px-8 shadow-lg text-base w-full sm:w-auto"
                    style={{ fontFamily: "'Poppins', sans-serif" }}
                  >
        ...
        <div className="container">
          <div className="text-center mb-10">
            ...
            <p
              ...
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              The Portfolio Planner is a beginner-friendly digital workbook for
              mapping your money, goals, and financial snapshot — available free
              or as a one-time $17 premium upgrade.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto mb-10">
            <div className="bg-white rounded-2xl border border-[#FECFA5] shadow-xl shadow-[#495E79]/8 overflow-hidden">
              <div className="bg-[#495E79] px-6 py-4 flex items-center gap-3">
                ...
                <span
                  className="ml-auto bg-[#F16953] text-white text-xs font-bold px-2.5 py-1 rounded-full"
                  style={{ fontFamily: "'Poppins', sans-serif" }}
                >
                  FREE + PREMIUM
                </span>
              ...
              <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div
                    key={item.label}
                    className="text-center p-3 bg-[#FAF9F7] rounded-lg"
                  >
                    <p
                      className="text-[#F16953] font-bold text-lg"
                      style={{ fontFamily: "'Poppins', sans-serif" }}
                    >
                      {item.value}
                    </p>
                    <p
                      className="text-[#5F7C84] text-xs mt-0.5"
                      style={{ fontFamily: "'DM Sans', sans-serif" }}
                    >
                      {item.label}
                    </p>
            ...
            <div className="rounded-xl border border-[#FECFA5] bg-[#FAF9F7] p-6">
              ...
              <ul className="space-y-2.5 mb-6">
                {freeFeatures.map((f) => (
                  <li
                    key={f}
                    className="flex items-start gap-2.5 text-sm text-[#495E79]"
                    style={{ fontFamily: "'DM Sans', sans-serif" }}
                  >
              ...
              <p
                className="text-center text-xs text-[#5F7C84] mt-2"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
              ...
              >
                <div className="flex gap-0.5 mb-3">
                  {Array.from({ length: t.stars }).map((_, j) => (
                    <Star
                      key={j}
                      className="w-3.5 h-3.5 fill-[#F16953] text-[#F16953]"
                    />
                  ))}
                </div>
                <p
      ...
      <section className="py-14 bg-[#FECFA5]/30 border-b border-[#FECFA5]">
        <div className="container">
          <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <p
                className="text-xs font-semibold uppercase tracking-widest text-[#F16953] mb-1"
                style={{ fontFamily: "'Poppins', sans-serif" }}
              >
                Roobens Finds Shop
              </p>
              <h2
                className="text-xl md:text-2xl font-bold text-[#495E79]"
                style={{ fontFamily: "'Poppins', sans-serif" }}
              >
                Browse digital products and curated items.
              </h2>
              <p
                className="text-[#5F7C84] text-sm mt-2"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
                All our digital downloads, planners, and hand-picked finds — in
                one place.
              </p>
            </div>
      ...
      <section className="py-16 bg-[#495E79]">
        <div className="container max-w-xl mx-auto text-center">
          ...
          <p
            ...
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            Join the Roobens Finds list. No spam, no fluff — just practical
            content and early access to new tools and finds.
          </p>
